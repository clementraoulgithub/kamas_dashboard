...
def backend_get_daily_kamas_value(server: str) -> dict | None:
    """
...
def backend_get_yesterday_kamas_value(server: str) -> dict | None:
    """
...
def backend_get_kamas_value(server: str) -> dict | None:
    """
